...
function WeeklyPlan({ setGroceryList, filterRecipes, handleFilterButtonClick }) {
    // moved to utils
    ...
    // handleFilterButtonClick(selectedIngredient);
    ...
    // filterRecipes(selectedIngredients, recipes);
